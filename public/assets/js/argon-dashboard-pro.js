...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        for (let e = 0; e < w.length; e++)
            sidenav.classList.contains("bg-dark") &&
        ...
        for (x = 0; x < h.length; x++)
            h[x].closest(".card.bg-gradient-dark") ||
                (h[x].classList.remove("text-white"),
